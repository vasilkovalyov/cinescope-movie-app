...
import { Input, InputProps, InputVariants, inputVariants } from '@/components/ui/input';
import { Textarea } from '@/components/ui/textarea';

type InputGroupProps = ComponentProps<'div'> & InputVariants;
...
function InputGroup({ className, ...props }: InputGroupProps) {
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group relative flex w-full min-w-0 items-center rounded-[12px] border border-input border-[rgba(255,255,255,0.08)] bg-accent-bg-1 transition-colors outline-none focus-within:border-primary/40',
        className,
        inputVariants,
      )}
      {...props}
